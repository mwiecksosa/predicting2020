...
- Conclusion: Predicting elections is hard. However, it was an amazing learning experience. Looking back, there are some things we would do differently, and some other ideas we would have liked to try if we had more time (e.g. using large language models instead of "old school" NLP techniques from 2010-2020).
